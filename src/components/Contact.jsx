  ...
  return (
    <section id="contact" className="relative overflow-hidden border-t hairline scroll-mt-16 grain">
      ...
      <div className="relative mx-auto max-w-[1440px] px-5 md:px-10 py-24 md:py-36">
        {/* Desktop visual — full-height right layer filling the whole area (xl and up only,
            so it never collides with the wide headline on smaller desktop widths) */}
        <div aria-hidden="true" className="absolute inset-y-0 right-0 hidden w-[54%] items-end justify-center pb-56 xl:flex">
          <ContactVisual />
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-6">
            <Reveal delay={0.1}>
              <p className="max-w-md text-[#c9c9c9] leading-relaxed">
          ...
          <Reveal delay={0.1} className="lg:col-span-6 xl:hidden">
            <ContactVisual />
          </Reveal>
        </div>
        </div>
